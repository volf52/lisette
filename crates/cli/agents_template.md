...
Read the relevant chapter in `target/.lisette/docs/` before writing Lisette.
...
NEVER modify anything inside `target/` — all generated by the compiler. Reading it is fine.
